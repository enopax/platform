    ...
    <div>
      ...
      <div className="mb-6">
        <div className="flex items-center gap-4 mb-6">
          <Link href={`/main/organisations/${orgName}/teams/${team.id}`}>
            ...
            <div className="p-6">
              {team.isPersonal ? (
                ...
                <TeamForm
                  ...
                  redirectUrl={`/main/organisations/${orgName}/teams/${team.id}`}
                />
              )}
            </div>
          </Card>
        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-2">
              <Link href={`/main/organisations/${orgName}/teams/${team.id}`} className="block">
