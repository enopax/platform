        ...
        <div className="flex items-center justify-between">
          <div className="flex-1">
            ...
            <p className="text-gray-600 dark:text-gray-300">
              Manage settings and configuration for {organisation.name}
            </p>
          </div>
          ...
          <Card>
            ...
            <div className="p-6">
              <OrganisationSettingsForm
                ...
                redirectUrl={`/main/organisations/${organisation.id}`}
              />
            </div>
          </Card>
        ...
        <div className="xl:col-span-1 space-y-6">
          <Card className="p-6">
            ...
            <div className="space-y-3 text-sm">
              ...
              {organisation._count.joinRequests > 0 && (
                <div>
                  <span className="text-gray-500">Pending Requests:</span>
                  <span className="ml-2 font-medium text-gray-900 dark:text-white">
                    {organisation._count.joinRequests}
                  </span>
                </div>
              )}
          ...
          <Card className="p-6">
            ...
            <div className="space-y-2">
              ...
              <Link href={`/main/organisations/${organisation.id}/members`} className="block">
                <Button variant="outline" size="sm" className="w-full justify-start">
                  <RiUserLine className="mr-2 h-4 w-4" />
                  Manage Members
                </Button>
