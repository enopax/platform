    ...
    <main className="mt-4">
      <Container>
        ...
        <nav className="flex items-center space-x-2 text-sm text-gray-600 dark:text-gray-400 mb-6">
          ...
          <RiArrowRightLine className="h-3 w-3" />
          <Link href={`/orga/${orgName}`} className="hover:text-gray-900 dark:hover:text-gray-100">
            {organisation.name}
          </Link>
          <RiArrowRightLine className="h-3 w-3" />
          <Link href={`/orga/${orgName}/resources`} className="hover:text-gray-900 dark:hover:text-gray-100">
            Resources
          </Link>
          <RiArrowRightLine className="h-3 w-3" />
              ...
              {resource.allocatedProjects.length === 0 ? (
                ...
                <div className="space-y-3">
                  {resource.allocatedProjects.map((allocation) => (
                    ...
                    >
                      <Link
                        href={`/orga/${orgName}/${allocation.project.name}`}
                        className="block"
                      >
