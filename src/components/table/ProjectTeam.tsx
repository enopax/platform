...
type ProjectTeamWithDetails = Team & {
  owner: User;
  _count?: {
    members: number;
    projects: number;
...
const columns: ColumnDef<ProjectTeamWithDetails>[] = [
  {
    header: 'Team Name',
    accessorKey: 'name',
    meta: {
  ...
  },
  {
    ...
    cell: ({ row }) => (
      <span className="flex gap-2 justify-end">
        <Tooltip content="View Team Details" asChild>
          <Button
            type="button"
            variant="light"
            size="sm"
...
export { columns, type ProjectTeamWithDetails };