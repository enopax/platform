    ...
    <DayPicker
      ...
      classNames={{
        ...
        day_selected: cx(
          ...
          "dark:aria-selected:bg-brand-500 dark:aria-selected:text-white",
        ),
        day_disabled:
        ...
        day_range_middle: cx(
          "rounded-none",
          "aria-selected:bg-brand-200 aria-selected:text-gray-900",
          "dark:aria-selected:bg-brand-900 dark:aria-selected:text-gray-50",
        ),
              ...
              {today && (
                <span
                  className={cx(
                    ...
                    {
                      "bg-brand-500 dark:bg-brand-500": !selected,
