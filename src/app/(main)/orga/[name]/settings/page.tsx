        ...
        <div className="xl:col-span-1 space-y-6">
          ...
          <Card className="p-6">
            ...
            <div className="space-y-2">
              <Link href={`/orga/${orgName}`} className="block">
                <Button variant="outline" size="sm" className="w-full justify-start">
                  <RiUserLine className="mr-2 h-4 w-4" />
                  View Members
                </Button>
              </Link>
              <Link href={`/orga/${orgName}/members`} className="block">
                <Button variant="outline" size="sm" className="w-full justify-start">
                  <RiUserLine className="mr-2 h-4 w-4" />
                  Manage Members
                </Button>
              </Link>
              <Link href="/orga" className="block">
                <Button variant="outline" size="sm" className="w-full justify-start">
